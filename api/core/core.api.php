 ...
 * - Http a cache object through \Drupal::cache() or by injecting a cache
 *   service.
 ...
 *   accessed via \Symfony\Component\HttpFoundation\Http::getSession(), which
 ...
 * \Symfony\Component\HttpFoundation\Http::getSession()
 ...
 * @code
 * public function counter(Http $request) {
 ...
 * }
 *
 * public function reset(Http $request) {
 *   $session = $request->getSession();
