...
class ResponseStatus extends ConditionPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function summary(): PluralTranslatableMarkup {
    ...
    if (!empty($this->configuration['negate'])) {
      return $this->formatPlural($count, 'Http response code is not: @codes', 'Http response code is not one of the following: @codes', ['@codes' => $codes]);
    }
    return $this->formatPlural($count, 'Http response code is: @codes', 'Http response code is one of the following: @codes', ['@codes' => $codes]);
  }
