...
class RendererBubblingTest extends RendererTestBase {
  ...
  public function testConditionalCacheContextBubblingSelfHealing(): void {
    ...
    // Http 1: role A, the grandchild isn't accessible => bubbled cache
    // contexts: user.roles.
    ...
    // Http 2: role B, the grandchild is accessible => bubbled cache
    ...
    // Http 3: role C, both the grandchild and the great grandchild are
